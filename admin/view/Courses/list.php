                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="so-luong"><?=$courseId ?></td>
                                            <td class="tieu-de"> <p><?=$title?></p> </td>
                                            <td class="image-course"><img style="width:100%" src="../../../assets/img/courses/<?=$image?>" alt=""></td>
                                            <td><p><?= $price ?>đ</p></td>
                                            <td><p><?php
                                                    if($sale == null){
                                                        echo 0;
                                            ...
                                            <td class="btn-thao-tac btn-thao-tac-column">
                                                ...
                                                <button type="button" class="btn btn-secondary" style="background-color: gray;">Chi tiết</button>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
