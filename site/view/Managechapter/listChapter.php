<section class="content-qt content-qt-admin">
    <div class="container container-qt" style="margin-bottom: 24px;">
        <div class="row">
            <div class="col-sm col-1">
                ...
                <div class="col-1-right">
                    <a href="<?= $SITE_URL ?>?mod=managechapter&act=addChapter&userId=<?=$_GET['userId']?>&courseId=<?= $_GET['courseId'] ?>"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-column align-items-center">
                                        <a href="<?= $SITE_URL ?>?mod=managechapter&act=editChapter&userId=<?=$_GET['userId']?>&courseId=<?= $_GET['courseId'] ?>&chapterId=<?= $chapterId ?>&numberOrder=<?= $numberOrder ?>&title=<?= $title ?>"
                                            class="btn-edit-admin">Sửa</a>
                                        <a href="<?= $SITE_URL ?>?mod=managechapter&act=listChapter&courseId=<?= $_GET['courseId'] ?>&chapterId=<?= $chapterId ?>"
                                            class="btn-delete-admin">Xóa</a>
                                        <a href="<?= $SITE_URL ?>?mod=managelesson&act=listLesson&userId=<?=$_GET['userId']?>&chapterId=<?= $chapterId ?>"
