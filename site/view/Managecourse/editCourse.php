    ...
    <div class="formInsertEdit__content">
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="formInsertEdit__item formInsertEdit__btn">
                ...
                <a href="<?= $SITE_URL ?>?mod=managecourse&act=addCourse&userId=<?=$userId?>" class="btn-insert">Thêm mới</a>
                <button type="reset" class="btn-reset">Nhập lại</button>
                <a href="<?= $SITE_URL ?>?mod=managecourse&act=listCourse&userId=<?=$userId?>" class="btn-list">Danh sách</a>
            </div>
        </form>
    </div>
</section>
